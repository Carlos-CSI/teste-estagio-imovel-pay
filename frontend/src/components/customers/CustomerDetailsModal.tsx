...
export default function CustomerDetailsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-labelledby="customer-details-title">
      <article className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="p-6 space-y-6 overflow-y-auto flex-1">
          ...
          <section aria-labelledby="charges-heading">
            <div className="flex items-center justify-between mb-3">
              <h3 id="charges-heading" className="font-semibold text-gray-900">
                Cobranças ({customer.charges?.length || 0})
              </h3>
            </div>
